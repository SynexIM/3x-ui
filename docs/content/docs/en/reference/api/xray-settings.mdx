...
_openapi:
  ...
  toc:
    ...
    - depth: 2
      title: Discard a staged upload the caller has given up on, instead of waiting
        for it to expire. Always answers 204, including for an upload id the
        panel does not hold.
      url: '#discard-a-staged-upload-the-caller-has-given-up-on-instead-of-waiting-for-it-to-expire-always-answers-204-including-for-an-upload-id-the-panel-does-not-hold'
    - depth: 2
  ...
  structuredData:
    headings:
      ...
      - content: Discard a staged upload the caller has given up on, instead of waiting
          for it to expire. Always answers 204, including for an upload id the
          panel does not hold.
        id: discard-a-staged-upload-the-caller-has-given-up-on-instead-of-waiting-for-it-to-expire-always-answers-204-including-for-an-upload-id-the-panel-does-not-hold
