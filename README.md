...
> This is the SynexIM fork of 3x-ui. It adds Mixed clients, native hot reload,
> traffic shaping, declarative node configuration, and runtime reconciliation.
> See [FORK.md](FORK.md) for the boundary with upstream and [RELEASE.md](RELEASE.md)
> for this fork's release channel.
...
For full documentation, please visit the [project Wiki](https://github.com/SynexIM-Labs/3x-ui/wiki).
...
```bash
docker run -d --cap-add=NET_ADMIN --cap-add=NET_RAW ... ghcr.io/synexim-labs/3x-ui
```
